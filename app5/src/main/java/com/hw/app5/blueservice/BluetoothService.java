...
public class BluetoothService extends Service {
    ...
    public static final String ACTION_BLUETOOTH_CONNECT_SUCCESSED = "app5_action_bluetooth_connect_successed";
    public static final String ACTION_BLUETOOTH_CONNECT_FAIL = "app5_action_bluetooth_connect_fail";
    public static final String ACTION_BLUETOOTH_WRITE_FAIL = "app5_action_bluetooth_write_failed";
    public static final String ACTION_BLUETOOTH_WRITE_SUCCESS = "app5_action_bluetooth_write_successed";
    public static final String ACTION_BLUETOOTH_DATA_RECIEVED = "app5_action_bluetooth_data_recieved";
    public static final String ACTION_BLUETOOTH_CONNECTION_LOST= "app5_action_bluetooth_connection_lost";
