...
public class Common {
    ...
    public class EResponsePacketFieldIndex
    {
        ...
        static final public byte  RspPacketFieldIndexIDENTIFIER       = 0X00;                             //match with CmdPacket identifier
        static final public byte  RspPacketFieldIndexLEN              = 0X00;
        static final public byte  RspPacketFieldIndexRESULT           = 0X00;
        static final public byte  RspPacketFieldIndexSCID             = 0X00;
        static final public byte  RspPacketFieldIndexDCID             = 0X00;                                   //APP RFCOMM Channel or HMI UNIX Domain Socket Channel
        static final public byte  RspPacketFieldIndexPAYLOAD          = 0X00;
