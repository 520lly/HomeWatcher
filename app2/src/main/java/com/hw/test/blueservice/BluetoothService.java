package com.hw.test.blueservice;
...
public class BluetoothService extends Service {
    ...
    public static final String ACTION_BLUETOOTH_CONNECT_SUCCESSED = "test_action_bluetooth_connect_successed";
    public static final String ACTION_BLUETOOTH_CONNECT_FAIL = "test_action_bluetooth_connect_fail";
    public static final String ACTION_BLUETOOTH_WRITE_FAIL = "test_action_bluetooth_write_failed";
    public static final String ACTION_BLUETOOTH_WRITE_SUCCESS = "test_action_bluetooth_write_successed";
    public static final String ACTION_BLUETOOTH_DATA_RECIEVED = "test_action_bluetooth_data_recieved";
    public static final String ACTION_BLUETOOTH_CONNECTION_LOST= "test_action_bluetooth_connection_lost";
...
//            mConnectThread.start();
    ...
    private class ConnectThread extends Thread {
        ...
        private BluetoothDevice mmDevice, grd;
        private UUID myUUID;
        ...
        public ConnectThread(BluetoothDevice device, UUID uuid) {
            ...
            try {
                ...
                Log.d(TAG,"remote device support uuids "+mmDevice.getUuids());
        ...
        public void run() {
            ...
            try {
                ...
                Log.e(TAG, "mConnectThread  mmSocket=" + mmSocket);
